...
#define MODULO_TEXTO_MENUOPCION1				5
#define MODULO_TEXTO_MENUOPCION2				6
#define MODULO_TEXTO_MENUOPCION1_SELECCIONADO	7
#define MODULO_TEXTO_MENUOPCION2_SELECCIONADO	8
#endif